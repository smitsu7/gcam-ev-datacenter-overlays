...
"$JAVA_HOME/bin/java" -Xmx4g \
  ...
  -l ../output/dc_validation/modelinterface_baseline_validation.log

"$JAVA_HOME/bin/java" -Xmx4g \
  -cp "../ModelInterface/ModelInterface.app/Contents/Resources/Java/ModelInterface.jar:../ModelInterface/ModelInterface.app/Contents/Resources/Java/jars/*" \
  ModelInterface.InterfaceMain \
  -b xmldb_batch_ssp_dc_validation.xml \
  -l ../output/dc_validation/modelinterface_validation.log

python3 ../scripts/compare_ssp_overlay_validation.py \
  --baseline ../output/dc_validation/baseline_validation.csv \
  --overlay ../output/dc_validation/dc_validation.csv \
  --out ../output/dc_validation/dc_minus_baseline.csv \
  --summary ../output/dc_validation/dc_minus_baseline_summary.csv
